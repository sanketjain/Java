//Supporting file is DemoServerThread.java and DataServiceThread.java
...
public class DemoClientThread {
	...
	public static void main(String[] args) {
		...
		try {
			Socket s1 = new Socket("localhost", 5552);  
			BufferedReader br = new BufferedReader(new InputStreamReader(s1.getInputStream())); //put input stream of Server in br
