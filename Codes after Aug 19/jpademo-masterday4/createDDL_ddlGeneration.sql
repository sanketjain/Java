CREATE TABLE project (project_id INTEGER NOT NULL, project_lead VARCHAR(255), project_name VARCHAR(255), PRIMARY KEY (project_id))
...
CREATE TABLE book (book_id INTEGER NOT NULL, AUTHOR VARCHAR(255), NAME VARCHAR(255), user_id INTEGER, PRIMARY KEY (book_id))
...
CREATE TABLE user_project_x (user_id INTEGER NOT NULL, project_id INTEGER NOT NULL, PRIMARY KEY (user_id, project_id))
ALTER TABLE car ADD CONSTRAINT FK_car_user_id FOREIGN KEY (user_id) REFERENCES user_info (user_id)
ALTER TABLE book ADD CONSTRAINT FK_book_user_id FOREIGN KEY (user_id) REFERENCES user_info (user_id)
...
ALTER TABLE user_project_x ADD CONSTRAINT FK_user_project_x_user_id FOREIGN KEY (user_id) REFERENCES user_info (user_id)
ALTER TABLE user_project_x ADD CONSTRAINT FK_user_project_x_project_id FOREIGN KEY (project_id) REFERENCES project (project_id)
